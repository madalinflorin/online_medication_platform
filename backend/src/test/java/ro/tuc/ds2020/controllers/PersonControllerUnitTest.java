...
public class PersonControllerUnitTest extends Ds2020TestConfig {
    ...
    public void insertPersonTest() throws Exception {
        ...
        PersonDetailsDTO personDTO = new PersonDetailsDTO(UUID.randomUUID(),
                "John", "Somewhere Else street", 22);
    ...
    public void insertPersonTestFailsDueToAge() throws Exception {
        ObjectMapper objectMapper = new ObjectMapper();
        PersonDetailsDTO personDTO = new PersonDetailsDTO(UUID.randomUUID(),"John", "Somewhere Else street", 17);
