...
class MedicalPlanForm1 extends React.Component {
 ...
 constructor(props) {
    ...
    registerMedicalPlan(username) {
        return API_USERS.postMedicalPlan(username, (result, status, error) => {
    ...
    handleSubmit() {
        ...
        this.registerMedicalPlan(this.state.formControls.username.value);
    }
...
export default MedicalPlanForm1;
