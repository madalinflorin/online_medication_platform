               ...
               <div className="form-group">
                ...
                <FormGroup id='medical_record'>
                                                                ...
                                                                <Input name='medical_record' id='medical_recordField' placeholder={this.state.formControls.medical_record.placeholder}
                                                                       ...
                                                                       required
                                                                />
                                                                {this.state.formControls.medical_record.touched && !this.state.formControls.medical_record.valid &&
                                                                <div className={"error-message row"}> * Medical record must have at least 1 character </div>}
                                </FormGroup>
